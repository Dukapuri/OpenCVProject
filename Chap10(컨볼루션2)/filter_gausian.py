...
gaussian_img1 = cv2.filter2D(image, -1, gaussian_2d)
gaussian_img2 = cv2.GaussianBlur(image, ksize, 0)
gaussian_img3 = cv2.sepFilter2D(image, -1, gaussian_1dX, gaussian_1dY)

titles = ['image', 'gaussian_img1', 'gaussian_img2', 'gaussian_img3']
